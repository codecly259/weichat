...
public class Face implements Comparable<Face> {
	...
	public double getSimilingValue() {
		return similingValue;
	}

	public void setSimilingValue(double similingValue) {
		this.similingValue = similingValue;
	}
